...
<ol>
<li>
First create a <code>jpcre2::Regex</code> object (You can use temporary object too, see [short examples](#short-examples)). This object will hold the pattern, modifiers, compiled pattern, error and warning codes.
