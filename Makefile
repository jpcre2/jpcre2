...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(top_srcdir)/src/config.h.in $(srcdir)/libpcre2-8.pc.in \
	$(srcdir)/libpcre2-16.pc.in $(srcdir)/libpcre2-32.pc.in \
	$(srcdir)/libpcre2-posix.pc.in $(srcdir)/pcre2-config.in \
	$(top_srcdir)/src/pcre2.h.in $(am__dist_noinst_SCRIPTS_DIST) \
	depcomp $(dist_man_MANS) $(dist_doc_DATA) $(dist_html_DATA) \
	$(include_HEADERS) test-driver COPYING ar-lib compile \
...
ACLOCAL = ${SHELL} /media/jahid/Storage/Git/github/neurobin/jpcre2/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /media/jahid/Storage/Git/github/neurobin/jpcre2/missing autoconf
AUTOHEADER = ${SHELL} /media/jahid/Storage/Git/github/neurobin/jpcre2/missing autoheader
AUTOMAKE = ${SHELL} /media/jahid/Storage/Git/github/neurobin/jpcre2/missing automake-1.14
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /media/jahid/Storage/Git/github/neurobin/jpcre2/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = PCRE2
PACKAGE_STRING = PCRE2 10.21-RC1
PACKAGE_TARNAME = pcre2
PACKAGE_URL = 
PACKAGE_VERSION = 10.21-RC1
PATH_SEPARATOR = :
PCRE2_DATE = 2015-07-06
PCRE2_MAJOR = 10
PCRE2_MINOR = 21
...
abs_builddir = /media/jahid/Storage/Git/github/neurobin/jpcre2
abs_srcdir = /media/jahid/Storage/Git/github/neurobin/jpcre2
abs_top_builddir = /media/jahid/Storage/Git/github/neurobin/jpcre2
abs_top_srcdir = /media/jahid/Storage/Git/github/neurobin/jpcre2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /media/jahid/Storage/Git/github/neurobin/jpcre2/install-sh
...
EXTRA_DIST = m4/ax_pthread.m4 m4/pcre2_visibility.m4 \
	...
	testdata/testinput20 testdata/testinputEBC \
