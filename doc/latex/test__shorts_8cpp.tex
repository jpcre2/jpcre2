...
\textcolor{comment}{/** @file test\_shorts.cpp}
\textcolor{comment}{ *  Contains some short examples of performing regex match and regex replace with JPCRE2}
\textcolor{comment}{ *  @include test\_shorts.cpp}
...
\textcolor{comment}{}    std::cout<<\textcolor{stringliteral}{"\(\backslash\)nTotal match of first match: "}<<vec\_num[0][0];      \textcolor{comment}{///Total match (group 0) from first
       match}
...
\textcolor{comment}{}    std::cout<<\textcolor{stringliteral}{"\(\backslash\)nCaptrued group 3 of frist match: "}<<vec\_num[0][3]; \textcolor{comment}{///captured group 3 doesn't exist, it
...
\textcolor{comment}{}        std::cout<<"\(\backslash\)nCaptrued group 4 of frist match: "<<vec\_num[0].at(4);
    \} catch (std::logic\_error e)\{
        std::cerr<<"\(\backslash\)nCaptrued group 4 doesn't exist";
    \}*/
    \textcolor{comment}{}
...
\textcolor{comment}{}            .\hyperlink{classjpcre2_1_1RegexMatch_ae495431f57cae54363331237ab21b56c}{setNamedSubstringVector}(&vec\_nas)
            .\hyperlink{classjpcre2_1_1RegexMatch_a04926e61d8b5f1d8bdf344efecd567d8}{setNameToNumberMapVector}(&vec\_ntn) \textcolor{comment}{/// Additional (name to number
       maps)}
...
\textcolor{comment}{}        std::cout<<"\(\backslash\)nCaptured group (name) of first match: "<<vec\_nas[0].at("name");
    \} catch(std::logic\_error e)\{
        std::cerr<<"\(\backslash\)nCaptured group (name) doesn't exist";
    \}*/
    \textcolor{comment}{}
