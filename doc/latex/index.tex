...
\href{https://travis-ci.org/jpcre2/jpcre2/}{\tt } \href{http://docs.neurobin.org/jpcre2/index.html}{\tt } \href{https://isocpp.org/}{\tt } \href{http://www.regular-expressions.info/pcre2.html}{\tt } \href{http://www.pcre.org/}{\tt }
...
This provides some C++ wrapper functions to perform regex operations such as regex match and regex replace.\hypertarget{index_dependency}{}\subsection{Dependency}\label{index_dependency}

\begin{DoxyEnumerate}
\item P\+C\+R\+E2 library ({\ttfamily version $>$=10.\+21}).
\end{DoxyEnumerate}

If the required P\+C\+R\+E2 version is not available in the official channel, you can download \href{https://github.com/jpcre2/pcre2}{\tt my fork of the library}.\hypertarget{index_install-or-include}{}\subsection{Install or Include}\label{index_install-or-include}
...
\end{DoxyEnumerate}\hypertarget{index_compile-a-regex-pattern}{}\subsubsection{Compile a regex pattern}\label{index_compile-a-regex-pattern}
\hypertarget{index_a-regex-object}{}\paragraph{A jpcre2\+::\+Regex object}\label{index_a-regex-object}
...
\end{DoxyCode}
 Each object for each regex pattern.\hypertarget{index_compile-the-regex}{}\paragraph{Compile the regex}\label{index_compile-the-regex}
...
re.\hyperlink{classjpcre2_1_1Regex_a85d9a514ea86ae68533223adac6c6bd8_a85d9a514ea86ae68533223adac6c6bd8}{setPattern}(\textcolor{stringliteral}{"(?:(?<word>[?.#@:]+)|(?<word>\(\backslash\)\(\backslash\)w+))\(\backslash\)\(\backslash\)s*(?<digit>\(\backslash\)\(\backslash\)d+)"})  \textcolor{comment}{//set pattern}
  .\hyperlink{classjpcre2_1_1Regex_ab1af1471339602446d8221b8c97c6b55_ab1af1471339602446d8221b8c97c6b55}{addModifier}(\textcolor{stringliteral}{"iJ"})                                                    \textcolor{comment}{//add modifier (J for
       PCRE2\_DUPNAMES)}
...
Now you can perform match or replace against the pattern. Use the {\ttfamily match()} member function to perform regex match and the {\ttfamily replace()} member function to perform regex replace.\hypertarget{index_check-regex}{}\paragraph{Check if regex compiled successfully}\label{index_check-regex}
You can check if the regex was compiled successfully or not, but {\bfseries it\textquotesingle{}s not required at all}. Any error will be handled automatically and you will always get the right answer, e.\+g a match against a non-\/compiled regex will give you 0 match and for replace you will be returned the exact subject string that you passed.


\begin{DoxyCode}
\textcolor{keywordflow}{if}(!re) std::cout<<\textcolor{stringliteral}{"Failed"};
\textcolor{keywordflow}{else} std::cout<<\textcolor{stringliteral}{"successfull"};
\end{DoxyCode}
 The {\ttfamily if(re)} conditional is only available for {\ttfamily $>$= C++11}\+:


\begin{DoxyCode}
\textcolor{keywordflow}{if}(re) std::cout<<\textcolor{stringliteral}{"Success"};
\textcolor{keywordflow}{else} std::cout<<\textcolor{stringliteral}{"Failure"};
\end{DoxyCode}
 For {\ttfamily $<$ C++11}, you can use the double bang trick as an alternative to {\ttfamily if(re)}\+:
...
\textcolor{keywordflow}{else} std::cout<<\textcolor{stringliteral}{"Failure"};
\end{DoxyCode}
\hypertarget{index_match}{}\subsubsection{Match}\label{index_match}
...
To get the match result (captured groups) however, you need to call the {\ttfamily \hyperlink{classjpcre2_1_1RegexMatch_a5868aef3a146594ea1ebef34d122bb33_a5868aef3a146594ea1ebef34d122bb33}{jpcre2\+::\+Regex\+Match\+::match()}} function. Point be noted that, you can not call this function directly or create any object of the class {\ttfamily \hyperlink{classjpcre2_1_1RegexMatch}{jpcre2\+::\+Regex\+Match}}. To call this function, first invoke the {\ttfamily \hyperlink{classjpcre2_1_1Regex_a519b0915bf1163c6ce6a4d674b30cfcd_a519b0915bf1163c6ce6a4d674b30cfcd}{jpcre2\+::\+Regex\+::init\+Match()}} (or {\ttfamily \hyperlink{classjpcre2_1_1Regex_abb007e99d7e2188ec80b741e7b40668f_abb007e99d7e2188ec80b741e7b40668f}{jpcre2\+::\+Regex\+::get\+Match\+Object()}}) function. It will give you a reference to a {\ttfamily \hyperlink{classjpcre2_1_1RegexMatch}{jpcre2\+::\+Regex\+Match}} object. Now you can chain method calls of {\ttfamily \hyperlink{classjpcre2_1_1RegexMatch_a2c7efe1ec2e13827f670db4ecedcd0a0_a2c7efe1ec2e13827f670db4ecedcd0a0}{jpcre2\+::\+Regex\+Match\+::set\+Numbered\+Substring\+Vector(\+Vec\+Num$\ast$ vec\+\_\+num)}} and such functions from {\ttfamily \hyperlink{classjpcre2_1_1RegexMatch}{jpcre2\+::\+Regex\+Match}} class to pass various parameters. After you are done passing all the parameter that you need, the {\ttfamily \hyperlink{classjpcre2_1_1RegexMatch_a5868aef3a146594ea1ebef34d122bb33_a5868aef3a146594ea1ebef34d122bb33}{jpcre2\+::\+Regex\+Match\+::match()}} function should be called to perform the actual match and return the match count. The match results will be stored in vectors (vectors of maps) whose pointers were passed as parameters.\hypertarget{index_check-if-a-string-matches-a-regex}{}\paragraph{Check if a string matches a regex}\label{index_check-if-a-string-matches-a-regex}

\begin{DoxyCode}
\textcolor{keywordflow}{if}(re.\hyperlink{classjpcre2_1_1Regex_ab93775a93a0a537d09b9e9ab4a5a3894_ab93775a93a0a537d09b9e9ab4a5a3894}{match}(\textcolor{stringliteral}{"I am the subject"})) std::cout<<\textcolor{stringliteral}{"matched (case sensitive)"};
\textcolor{keywordflow}{else} std::cout<<\textcolor{stringliteral}{"Didn't match"};

\textcolor{keywordflow}{if}(re.\hyperlink{classjpcre2_1_1Regex_ab93775a93a0a537d09b9e9ab4a5a3894_ab93775a93a0a537d09b9e9ab4a5a3894}{match}(\textcolor{stringliteral}{"I am the subject"},\textcolor{stringliteral}{"i"})) std::cout<<\textcolor{stringliteral}{"matched (case insensitive)"};
\textcolor{keywordflow}{else} std::cout<<\textcolor{stringliteral}{"Didn't match"};
\end{DoxyCode}
\hypertarget{index_simple-match-count}{}\paragraph{Get match count}\label{index_simple-match-count}

\begin{DoxyCode}
\textcolor{keywordtype}{size\_t} count = \hyperlink{classjpcre2_1_1Regex}{jpcre2::Regex}(\textcolor{stringliteral}{"(\(\backslash\)\(\backslash\)d)|(\(\backslash\)\(\backslash\)w)"},\textcolor{stringliteral}{"i"}).\hyperlink{classjpcre2_1_1Regex_ab93775a93a0a537d09b9e9ab4a5a3894_ab93775a93a0a537d09b9e9ab4a5a3894}{match}(\textcolor{stringliteral}{"I am the subject"},\textcolor{stringliteral}{"g"});
\end{DoxyCode}
...
\textcolor{keywordtype}{size\_t} count=re.\hyperlink{classjpcre2_1_1Regex_a519b0915bf1163c6ce6a4d674b30cfcd_a519b0915bf1163c6ce6a4d674b30cfcd}{initMatch}()                                 \textcolor{comment}{//Initialize match object}
               ...
               .\hyperlink{classjpcre2_1_1RegexMatch_a2c7efe1ec2e13827f670db4ecedcd0a0_a2c7efe1ec2e13827f670db4ecedcd0a0}{setNumberedSubstringVector}(&vec\_num)        \textcolor{comment}{//pass pointer to
       VecNum vector to store maps of numbered substrings}
...
{\itshape The process of iterating through the vectors and associated maps are the same for all three. The size of those vectors are the same and can be accessed in the same way.}\hypertarget{index_re-use-a-match-object}{}\paragraph{Re-\/use a match object}\label{index_re-use-a-match-object}
Match object is a private property of {\ttfamily \hyperlink{classjpcre2_1_1Regex}{jpcre2\+::\+Regex}} class. You either have to use {\ttfamily \hyperlink{classjpcre2_1_1Regex_a519b0915bf1163c6ce6a4d674b30cfcd_a519b0915bf1163c6ce6a4d674b30cfcd}{jpcre2\+::\+Regex\+::init\+Match()}} or {\ttfamily \hyperlink{classjpcre2_1_1Regex_abb007e99d7e2188ec80b741e7b40668f_abb007e99d7e2188ec80b741e7b40668f}{jpcre2\+::\+Regex\+::get\+Match\+Object()}} function to get a reference to it. The only difference between these two is\+: {\ttfamily init\+Match()} always creates a new match object deleting the previous one, while {\ttfamily get\+Match\+Object()} gives you a reference to the existing match object if available, otherwise creates it.
...
re.\hyperlink{classjpcre2_1_1Regex_a519b0915bf1163c6ce6a4d674b30cfcd_a519b0915bf1163c6ce6a4d674b30cfcd}{initMatch}()                                \textcolor{comment}{//invoke the initMatch() function}
  .\hyperlink{classjpcre2_1_1RegexMatch_a2c7efe1ec2e13827f670db4ecedcd0a0_a2c7efe1ec2e13827f670db4ecedcd0a0}{setNumberedSubstringVector}(&vec\_num)       \textcolor{comment}{//pointer to numbered substring
       vector}
  .\hyperlink{classjpcre2_1_1RegexMatch_ae495431f57cae54363331237ab21b56c_ae495431f57cae54363331237ab21b56c}{setNamedSubstringVector}(&vec\_nas)          \textcolor{comment}{//pointer to named substring vector}
  .\hyperlink{classjpcre2_1_1RegexMatch_a04926e61d8b5f1d8bdf344efecd567d8_a04926e61d8b5f1d8bdf344efecd567d8}{setNameToNumberMapVector}(&vec\_ntn)         \textcolor{comment}{//pointer to name-to-number map
       vector}
\end{DoxyCode}
...
\begin{DoxyCode}
\textcolor{keywordtype}{size\_t} count = re.\hyperlink{classjpcre2_1_1Regex_abb007e99d7e2188ec80b741e7b40668f_abb007e99d7e2188ec80b741e7b40668f}{getMatchObject}()
                 .\hyperlink{classjpcre2_1_1RegexMatch_a635c652195deaa8ebb9e107c4f972aab_a635c652195deaa8ebb9e107c4f972aab}{setSubject}(\textcolor{stringliteral}{"I am the subject"})
                 .\hyperlink{classjpcre2_1_1RegexMatch_a9df7e92f96b61553f62720cb8f5f23e5_a9df7e92f96b61553f62720cb8f5f23e5}{setModifier}(\textcolor{stringliteral}{"i"})
                 .\hyperlink{classjpcre2_1_1RegexMatch_a5868aef3a146594ea1ebef34d122bb33_a5868aef3a146594ea1ebef34d122bb33}{match}()
\end{DoxyCode}
 We can perform this kind of matches as many times as we want. The vectors always get re-\/initialized and thus contain new data.\hypertarget{index_replace}{}\subsubsection{Replace or Substitute}\label{index_replace}
...
\textcolor{comment}{//1234 gets replaced with 5678}
\end{DoxyCode}
\hypertarget{index_using-method-chain}{}\paragraph{Using method chain}\label{index_using-method-chain}
...
These modifiers define the behavior of a regex pattern (they are integrated in the compiled regex). They have more or less the same meaning as the \href{https://php.net/manual/en/reference.pcre.pattern.modifiers.php}{\tt P\+HP regex modifiers} except for {\ttfamily e, j and n} (marked with \textsuperscript{$\ast$}).
...
These options are meaningful only for the {\bfseries J\+P\+C\+R\+E2} library, not the original {\bfseries P\+C\+R\+E2} library. We use the {\ttfamily \hyperlink{classjpcre2_1_1Regex_a03974fa7ba8f7c47186cb8d6f54934de_a03974fa7ba8f7c47186cb8d6f54934de}{jpcre2\+::\+Regex\+::add\+Jpcre2\+Option()}} family of functions to pass these options.
...
While having its own way of doing things, J\+P\+C\+R\+E2 also supports the traditional P\+C\+R\+E2 options to be passed (and it\textquotesingle{}s faster than passing modifier). We use the {\ttfamily \hyperlink{classjpcre2_1_1Regex_a2c7dcf12f26b2b046e147b013c8b5087_a2c7dcf12f26b2b046e147b013c8b5087}{jpcre2\+::\+Regex\+::add\+Pcre2\+Option()}} family of functions to pass the P\+C\+R\+E2 options. These options are the same as the P\+C\+R\+E2 library and have the same meaning. For example instead of passing the \textquotesingle{}g\textquotesingle{} modifier to the replacement operation we can also pass its P\+C\+R\+E2 equivalent {\ttfamily P\+C\+R\+E2\+\_\+\+S\+U\+B\+S\+T\+I\+T\+U\+T\+E\+\_\+\+G\+L\+O\+B\+AL} to have the same effect.\hypertarget{index_exception-handling}{}\subsection{Error handling}\label{index_exception-handling}
When a known error is occurred during pattern compilation or match or replace, the error number and error offsets are set to corresponding variables of {\ttfamily \hyperlink{classjpcre2_1_1Regex}{jpcre2\+::\+Regex}} class. You can get the error number, error offset and error message with {\ttfamily \hyperlink{classjpcre2_1_1Regex_a7294273e7d11907a749f2db40da9ed15_a7294273e7d11907a749f2db40da9ed15}{jpcre2\+::\+Regex\+::get\+Error\+Number()}}, {\ttfamily \hyperlink{classjpcre2_1_1Regex_ae8c6c8f728c58d9b171c68b4b166e195_ae8c6c8f728c58d9b171c68b4b166e195}{jpcre2\+::\+Regex\+::get\+Error\+Offset()}} and {\ttfamily \hyperlink{classjpcre2_1_1Regex_a8606fff8b192c94f58ca9e82aa048c61_a8606fff8b192c94f58ca9e82aa048c61}{jpcre2\+::\+Regex\+::get\+Error\+Message()}} functions respectively.

{\bfseries Note} that, these errors always gets overwritten by previous error, so you only get the last error that occurred.

{\bfseries Also note} that, these errors never get re-\/initialized (se to zero), they are always there even when everything else worked great (except some previous error). But these are harmless. {\bfseries You never need to worry about errors unless you want to experiment/debug}

If you do experiment with various erroneous situations, make use of the {\ttfamily reset\+Errors()} function. You can call it from anywhere in your method chain and immediately set the errors to zero. This function is defined for all three classes and do the same thing.

If you want to debug, you should also use {\ttfamily \#define J\+P\+C\+R\+E2\+\_\+\+E\+N\+A\+B\+L\+E\+\_\+\+D\+E\+B\+U\+G\+\_\+\+M\+O\+DE} before including {\ttfamily \hyperlink{jpcre2_8hpp}{jpcre2.\+hpp}}\hypertarget{index_short-examples}{}\subsection{Short examples}\label{index_short-examples}
