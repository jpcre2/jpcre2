...
{\bfseries Also note} that, these errors never get re-\/initialized (se to zero), they are always there even when everything else worked great (except some previous error). But these are harmless.
