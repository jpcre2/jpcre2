...
When a known error is occurred during pattern compilation or match or replace, an exception of type \hyperlink{classjpcre2_1_1Except}{jpcre2\+::\+Except} is thrown. The \hyperlink{classjpcre2_1_1Except}{jpcre2\+::\+Except} class provides public member functions to get the error number, error offset and error message.
