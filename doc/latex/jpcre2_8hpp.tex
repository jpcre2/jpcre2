...
\begin{DoxyCompactList}\small\item\em This class implements public overloaded and copy constructors to provide different means of creating objects and initializing class variables. \end{DoxyCompactList}\end{DoxyCompactItemize}
